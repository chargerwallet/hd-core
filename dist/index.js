...
const createCoreApi = (call) => ({
    ...
    getChargerwalletatures: (connectId, params) => call(Object.assign(Object.assign({}, params), { connectId, method: 'getChargerwalletatures' })),
...
var nested$1 = {
	...
	MessageType: {
		...
		values: {
			...
			MessageType_Chargerwalletatures: 10026
		}
	},
	google: {
		nested: {
...
const corsValidator = (url) => {
    if (typeof url !== 'string')
        return;
    if (url.match(/^https:\/\/([A-Za-z0-9\-_]+\.)*chargerwallet\.so\//))
        return url;
...
class GetChargerwalletatures extends BaseMethod {
    init() {
        this.notAllowDeviceMode = [
            ...this.notAllowDeviceMode,
            UI_REQUEST.INITIALIZE,
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            const { message } = yield this.device.commands.typedCall('ChargerwalletGetFeatures', 'Chargerwalletatures');
    ...
    init() {
        ...
        this.shouldConfirm =
            this.payload.showOnChargerWallet ||
                ((_b = this.payload.bundle) === null || _b === void 0 ? void 0 : _b.some((i) => !!i.showOnChargerWallet));
        validateParams(payload, [{ name: 'bundle', type: 'array' }]);
        this.params = [];
        payload.bundle.forEach((batch) => {
            var _a;
...
class XrpGetAddress$1 extends BaseMethod {
    ...
    init() {
        ...
        this.shouldConfirm = this.hasBundle
            ? this.payload.bundle.some((i) => !!i.showOnChargerWallet)
            : false;
        validateParams(payload, [{ name: 'bundle', type: 'array' }]);
        this.params = [];
        payload.bundle.forEach((batch) => {
...
var ApiMethods = /*#__PURE__*/Object.freeze({
    ...
    getChargerwalletatures: GetChargerwalletatures,
