...
export declare function cardanoGetPublicKey(connectId: string, deviceId: string, params: CommonParams & CardanoPublicKeyMethodParams): Response<CardanoPublicKey>;
export declare function cardanoGetPublicKey(connectId: string, deviceId: string, params: CommonParams & {
