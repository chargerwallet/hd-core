...
export declare function dnxGetAddress(connectId: string, deviceId: string, params: CommonParams & DnxGetAddressParams): Response<DnxAddress>;
export declare function dnxGetAddress(connectId: string, deviceId: string, params: CommonParams & {
