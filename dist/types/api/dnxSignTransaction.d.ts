import { UintType } from '@chargerwallet/hd-transport';
...
export declare function dnxSignTransaction(connectId: string, deviceId: string, params: CommonParams & DnxSignTransactionParams): Response<DnxSignature>;
