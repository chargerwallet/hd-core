...
export declare function nemGetAddress(connectId: string, deviceId: string, params: CommonParams & NEMGetAddressParams): Response<NEMAddress>;
export declare function nemGetAddress(connectId: string, deviceId: string, params: CommonParams & {
