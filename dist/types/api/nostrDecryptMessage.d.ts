...
export declare function nostrDecryptMessage(connectId: string, deviceId: string, params: CommonParams & NostrDecryptMessageParams): Response<NostrDecryptedMessageResponse>;
