...
export declare function nostrEncryptMessage(connectId: string, deviceId: string, params: CommonParams & NostrEncryptMessageParams): Response<NostrEncryptedMessageResponse>;
