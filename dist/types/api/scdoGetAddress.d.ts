...
export declare function scdoGetAddress(connectId: string, deviceId: string, params: CommonParams & ScdoGetAddressParams): Response<ScdoAddress>;
export declare function scdoGetAddress(connectId: string, deviceId: string, params: CommonParams & {
