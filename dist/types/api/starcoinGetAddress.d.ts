...
export declare function starcoinGetAddress(connectId: string, deviceId: string, params: CommonParams & StarcoinGetAddressParams): Response<StarcoinAddress>;
export declare function starcoinGetAddress(connectId: string, deviceId: string, params: CommonParams & {
