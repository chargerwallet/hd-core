import type { TonSignedMessage, TonWalletVersion, TonWorkChain, UintType } from '@chargerwallet/hd-transport';
...
export declare function tonSignMessage(connectId: string, deviceId: string, params: CommonParams & TonSignMessageParams): Response<TonSignedMessageResponse>;
